...
static void display_about_dialog(GtkAction *action, WinPickerApp *applet);

static void display_prefs_dialog(GtkAction *action, WinPickerApp *applet);

static const GtkActionEntry window_picker_menu_actions[] = {
    {"MenuPrefs", "preferences-system", N_("_Preferences"), NULL, NULL,
     G_CALLBACK(display_prefs_dialog)},
    {"MenuAbout", "help-about", N_("_About"), NULL, NULL,
     G_CALLBACK(display_about_dialog)}};

static const gchar *close_window_authors[] = {
    "Neil J. Patel <neil.patel@canonical.com>",
    "Stefano Karapetsas <stefano@karapetsas.com>", NULL};

static void on_show_all_windows_changed(GSettings *settings, gchar *key,
                                        gpointer data) {
  WinPickerApp *app;
...
static void on_show_home_title_changed(GSettings *settings, gchar *key,
                                       gpointer data) {
  WinPickerApp *app;
...
static void on_bold_window_title_changed(GSettings *settings, gchar *key,
                                         gpointer data) {
  WinPickerApp *app;
...
static void cw_applet_finalize(GObject *object) {
  if (G_OBJECT_CLASS(parent_class)->finalize)
    (*G_OBJECT_CLASS(parent_class)->finalize)(object);
}

static gboolean cw_applet_fill(MatePanelApplet *applet, const gchar *iid,
                               gpointer data) {
  WinPickerApp *app;
  ...
  gtk_action_group_add_actions(action_group, window_picker_menu_actions,
                               G_N_ELEMENTS(window_picker_menu_actions), app);
  mate_panel_applet_setup_menu_from_file(MATE_PANEL_APPLET(app->applet),
                                         MATEWINDOWPICKER_MENU_UI_DIR
                                         "/mate-window-picker-applet-menu.xml",
                                         action_group);
...
MATE_PANEL_APPLET_OUT_PROCESS_FACTORY("MateWindowPickerFactory",
                                      PANEL_TYPE_APPLET, "MateWindowPicker",
                                      cw_applet_fill, NULL);
...
static void display_about_dialog(GtkAction *action, WinPickerApp *applet) {
  ...
  g_object_set(panel_about_dialog, "name", _("Window Picker"), "comments",
               _("Window Picker"), "version", PACKAGE_VERSION, "authors",
               close_window_authors, "icon-name", "preferences-system-windows",
...
static void on_show_win_key_checkbox_toggled(GtkToggleButton *check,
                                             gpointer null) {
  gboolean is_active;
...
static void on_show_home_title_checkbox_toggled(GtkToggleButton *check,
                                                gpointer null) {
  gboolean is_active;
...
static void on_bold_window_title_checkbox_toggled(GtkToggleButton *check,
                                                  gpointer null) {
  gboolean is_active;
...
static void display_prefs_dialog(GtkAction *action, WinPickerApp *applet) {
  ...
  check = gtk_check_button_new_with_label(
      _("Show desktop title and logout button"));
  gtk_widget_set_tooltip_text(GTK_WIDGET(check),
                              _("Show a title for the desktop when no window "
                                "is selected, and append a logout button."));
  gtk_box_pack_start(GTK_BOX(vbox), check, FALSE, TRUE, 0);
  gtk_toggle_button_set_active(
      GTK_TOGGLE_BUTTON(check),
